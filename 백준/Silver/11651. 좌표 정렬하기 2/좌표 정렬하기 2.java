...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        Arrays.sort(arrays, (num1, num2) -> { // (num1, num2) -> { ... } (람다 함수)
            return num1[1]!=num2[1] ? num1[1]-num2[1] : num1[0]-num2[0]; // 두 배열의 두 번째 원소가 다르면, **num1[1] - num2[1]**를 반환하여 두 번째 원소를 기준으로 오름차순 정렬,, num1[1] < num2[1]이면 음수가 반환되므로 num1이 먼저
            // num1[1] == num2[1]: 두 배열의 두 번째 원소가 같으면, **num1[0] - num2[0]**를 반환하여 첫 번째 원소를 기준으로 오름차순 정렬
        });
